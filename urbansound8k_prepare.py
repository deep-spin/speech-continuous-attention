...
if __name__ == "__main__":
    ...
    speechbrain.utils.distributed.run_on_main(
        ...
        kwargs={
            "data_folder": "/mnt/data-zeus2/mtreviso/data/corpus/urbansound8k",
            "audio_data_folder": "/mnt/data-zeus2/mtreviso/data/corpus/urbansound8k/audio",
            "save_json_train": "data/urbansound8k/manifest/train.json",
            "save_json_valid": "data/urbansound8k/manifest/valid.json",
            "save_json_test": "data/urbansound8k/manifest/test.json",
            "train_fold_nums": [1, 2, 3, 4, 5, 6, 7, 8],
            "valid_fold_nums": [9],
            "test_fold_nums": [10],
        },
